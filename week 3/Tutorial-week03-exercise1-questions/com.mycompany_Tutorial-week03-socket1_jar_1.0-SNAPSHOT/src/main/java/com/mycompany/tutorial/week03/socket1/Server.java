    ...
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            while (true) {                
                ...
                System.out.println("[SERVER] - Client has connected: " + clientSocket.getInetAddress());
                ...
                out.println("[SERVER] - server received your message: " + message);

                /* **Close the client socket. The close method of the Socket class closes the client socket and 
                releases all associated resources.** */
                clientSocket.close();
                System.out.println("[SERVER] - Client has been disconnected " + clientSocket.getInetAddress());
            }
